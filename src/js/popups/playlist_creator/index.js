...
class PlaylistCreator extends Component {
   ...
   createPlaylist = () => {
      ...
      if (!title || !description) {
         alert("Tambahkan judul dan deskripsi!");
         return;
      }
   ...
   render() {
      ...
      return (
         <Container index={index} closing={closing}>
            <Header
               left={<Button onClick={this.props.popPopup}>Batal</Button>}
               center={<Title>Daftar Putar Baru</Title>}
               right={
            ...
            <Section>
               ...
               />
               <TitleInput id="playlist-title" placeholder="Nama Daftar Putar" />
            </Section>
            <Section>
               <DescriptionInput
